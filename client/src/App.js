...
function App() {
  ...
  const openModalExpense = () => setIsOpenExpense(true);
  const closeModalExpense = () => setIsOpenExpense(false);
  
  const openModalBudget = () => setIsOpenBudget(true);
  const closeModalBudget = () => setIsOpenBudget(false);
  
  const openModalSignup = () => setIsOpen(true);
  const closeModalSignup = () => setIsOpen(false);
